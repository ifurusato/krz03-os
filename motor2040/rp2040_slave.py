...
class RP2040_Slave:
    ...
    def __init__(self, i2cID=0, sda=0, scl=1, slaveAddress=0x44):
        self._log = Logger('i2c_slave', Level.INFO)
        self.scl = scl
        self.sda = sda
        ...
        self._log.info('established I2C slave on ID={}; SDA={}; SCL={} at 0x{:02X}'.format(i2cID, sda, scl, self.slaveAddress))
...
#       addr = 0x00
#
#       s_i2c = RP2040_Slave(0,sda=0,scl=1,slaveAddress=0x44)
