...
# -*- coding: utf-8 -*-
#
# this is a temporary file, to be replaced by the existing digital_pot.py
...
#       print('value: {:.2f}'.format(self.value))
#       print(f'analog: {self.analog:.2f}; value: {self.value:.2f}; rgb={r},{g},{b}')
    ...
    def start(self):
        ...
        def run_loop():
            ...
            try:
                ...
                print(f"[LEDController] Exception in run_loop: {e}")
            finally:
                self._loop.close()
