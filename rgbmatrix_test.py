...
# ┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
def set_matrix(array, matrix, color=Color.ORANGE):
    for y in range(0,5):
        for x in range(0,5):
            if array[x][y] == 1:
                _color = color
    ...
    try:
        ...
        if _do_test_suite:
            ...
            _types = [ 
                ...
                DisplayType.SOLID,
                DisplayType.WIPE_UP,
                DisplayType.WIPE_DOWN,
                DisplayType.WIPE_LEFT,
                DisplayType.WIPE_RIGHT
            ]

#           _types = [ DisplayType.RANDOM ]
#           _types = [ DisplayType.WIPE_DOWN, DisplayType.WIPE_UP ]
